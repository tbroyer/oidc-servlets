...
public class IsAuthenticatedFilter extends HttpFilter {
  ...
  protected void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
    ...
    if (req.getUserPrincipal() != null
        || req.getRequestURI().equals(configuration.callbackPath())) {
  ...
  private void redirectToAuthenticationEndpoint(HttpServletRequest req, HttpServletResponse res) {
